...
int main( int argc, char* argv[] ) {
  ...
  std::cout << "Target Layer       : " << targetLayer << std::endl;
  ...
  ClusterAnalysis::SetPileupWeightFile(pileupWeightFile);
  ClusterAnalysis *alg = new ClusterAnalysis;
  alg -> SetTargetLayer(targetLayer);
  job.algsAdd(alg);
