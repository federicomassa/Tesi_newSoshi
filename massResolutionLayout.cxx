...
void draw(std::vector<TH1F*>& v, const std::string& xaxis, const double yhigh, const std::string& imageName) {
...
void massResolution(const char* fname1, const char* fname2, const char* fname3) {
  ...
  std::vector<TH1F*> onShell27, offShell27, tot27,
  ...
  for (int i = 0; i < 3; i++) {
    ...
    plotStyle(onShell4.back(), "", 10, "m_{#mu#mu} [GeV]", "", color, -20, 20); 
    ...
    plotStyle(tot4.back(), "", 10, "m_{4} [GeV]", "", color, -20, 20); 
  ...
  draw(onShell27, "#mu#mu mass - truth on-shell Z boson mass [GeV]", 0.16, "sigRecoOnShell27");
  draw(onShell32, "#mu#mu mass - truth on-shell Z boson mass [GeV]", 0.16, "sigRecoOnShell32");
  draw(onShell4, "#mu#mu mass - truth on-shell Z boson mass [GeV]", 0.16, "sigRecoOnShell4");

  draw(offShell27, "#mu#mu mass - truth off-shell Z boson mass [GeV]", 0.18, "sigRecoOffShell27");
  draw(offShell32, "#mu#mu mass - truth off-shell Z boson mass [GeV]", 0.18, "sigRecoOffShell32");
  draw(offShell4, "#mu#mu mass - truth off-shell Z boson mass [GeV]", 0.18, "sigRecoOffShell4");

  draw(tot27, "4#mu mass - truth Higgs boson mass [GeV]", 0.16, "sigRecoOffShell27");
  draw(tot32, "4#mu mass - truth Higgs boson mass [GeV]", 0.16, "sigRecoOffShell32");
  draw(tot4, "4#mu mass - truth Higgs boson mass [GeV]", 0.16, "sigRecoOffShell4");
