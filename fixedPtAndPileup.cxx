...
void fixedPtAndPileup(const string& particle, const double& pt, const int& pileup) {
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sigPt_abseta->AddEntry(sigPt_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sigPt_abseta  -> SetFillColor(0);
  leg_sigPt_abseta  -> Draw();
  
  canv_sigPt_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sigPt_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sigQPt_abseta->AddEntry(sigQPt_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sigQPt_abseta  -> SetFillColor(0);
  leg_sigQPt_abseta  -> Draw();
  
  canv_sigQPt_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sigQPt_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sigPhi_abseta->AddEntry(sigPhi_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sigPhi_abseta  -> SetFillColor(0);
  leg_sigPhi_abseta  -> Draw();
  
  canv_sigPhi_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sigPhi_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sigD0_abseta->AddEntry(sigD0_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sigD0_abseta  -> SetFillColor(0);
  leg_sigD0_abseta  -> Draw();
  
  canv_sigD0_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sigD0_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sigZ0_abseta->AddEntry(sigZ0_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sigZ0_abseta  -> SetFillColor(0);
  leg_sigZ0_abseta  -> Draw();
  
  canv_sigZ0_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sigZ0_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sysPt_abseta->AddEntry(sysPt_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sysPt_abseta  -> SetFillColor(0);
  leg_sysPt_abseta  -> Draw();
  
  canv_sysPt_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sysPt_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sysQPt_abseta->AddEntry(sysQPt_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sysQPt_abseta  -> SetFillColor(0);
  leg_sysQPt_abseta  -> Draw();
  
  canv_sysQPt_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sysQPt_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sysPhi_abseta->AddEntry(sysPhi_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sysPhi_abseta  -> SetFillColor(0);
  leg_sysPhi_abseta  -> Draw();
  
  canv_sysPhi_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sysPhi_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sysD0_abseta->AddEntry(sysD0_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sysD0_abseta  -> SetFillColor(0);
  leg_sysD0_abseta  -> Draw();
  
  canv_sysD0_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sysD0_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_sysZ0_abseta->AddEntry(sysZ0_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_sysZ0_abseta  -> SetFillColor(0);
  leg_sysZ0_abseta  -> Draw();
  
  canv_sysZ0_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_sysZ0_abseta.png").c_str(), "png");
  ...
  canv_eff_abseta -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_eff_abseta.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_eff_phi->AddEntry(eff_phi[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
  
  leg_eff_phi  -> SetFillColor(0);
  leg_eff_phi  -> Draw();
  
  canv_eff_phi -> Print(("Plots/Mixed/" + particle_lower + pt_str + "pu" + pileup_str + "layouts_eff_phi.png").c_str(), "png");
  ...
  for (unsigned int i = 0; i < Layouts.size(); i++) 
    leg_fakeProb_abseta->AddEntry(fakeProb_abseta[i], (particle_lower + pt_str + "pu" + pileup_str + ": " + Layouts[i]).c_str(), "lp");
